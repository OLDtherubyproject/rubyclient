...
function init()
  ...
  showTopMenuButton.onClick = function()
	...
	ProtocolGame.registerExtendedOpcode(12,function(protocol, opcode, buffer) showSkills(buffer) end)
  ...
  if creatureThing then
    ...
    if creatureThing:isLocalPlayer() then
      ...
      if creatureThing:isPlayer() then
        ...
        menu:addOption(tr('Skills'), function() getSkills(creatureThing:getName()) end)
      end
    end
...
function showSkills(buffer)
  skillsWindow = g_ui.loadUI('skills', modules.game_interface.getRightPanel())
  skillsWindow:setup()

  local skills = split(buffer, ',')
  ...
  setSkillValue('skillId3', skills[8])
  setSkillValue('skillId4', skills[9])
  setSkillValue('skillId5', skills[10])
  setSkillValue('skillId6', skills[11])
end
